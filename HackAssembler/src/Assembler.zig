...
const SymbolMap = @import("map/SymbolMap.zig");
...
const OUTPUT_FILE: []const u8 = "./test/Rect.hack";

test "smoke" {
    var assembler = try init(TEST_FILE, OUTPUT_FILE, testing.io, testing.allocator);
